...
\input{design/smart-contracts}
\input{design/social-trust-certificates}
\input{design/guest-client}
\input{design/host-client}
\input{design/identity-approver}
\input{design/access-controll}
\input{design/access-terminal}
